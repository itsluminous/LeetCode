...
public class Solution {
    public double FindMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        while(l <= r){
            ...
            var splitLeftn1 = n1split > 0 ? nums1[n1split-1] : int.MinValue;
            var splitLeftn2 = n2split > 0 ? nums2[n2split-1] : int.MinValue;
            var splitRightn1 = n1split < n1 ? nums1[n1split] : int.MaxValue;
            var splitRightn2 = n2split < n2 ? nums2[n2split] : int.MaxValue;
